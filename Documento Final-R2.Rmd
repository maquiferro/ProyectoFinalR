...
# Análisis de gráficas en ggplot2
...
carburantes <-read.table("./recursos/carburantes_20050222.csv",sep = "\t", header = 
                           TRUE,fill = TRUE,na.strings = ".",quote = "",dec = ",",encoding = "UTF-8")


ggplot(carburantes, aes(Provincia)) +
  geom_density()
